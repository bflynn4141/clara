...
// Realistic pool data structure from DeFiLlama
interface MockPool {
  pool: string;
  chain: string;
  project: string;
 ...
 */
export const MULTIPLE_OPPORTUNITIES: { data: MockPool[] } = {
  data: [
    {
 ...
 */
export const NO_OPPORTUNITIES: { data: MockPool[] } = {
  data: [],
};
 ...
 */
export const ALL_FILTERED_OUT: { data: MockPool[] } = {
  data: [
    {
 ...
 */
export const LOW_TVL_POOLS: { data: MockPool[] } = {
  data: [
    {
 ...
 */
export const MIXED_ASSETS: { data: MockPool[] } = {
  data: [
    {
      pool: "aave-v3-base-usdc",
      chain: "Base",
 ...
 */
export const NULL_APY_VALUES: { data: MockPool[] } = {
  data: [
    {
      pool: "aave-v3-base-usdc",
      chain: "Base",
 ...
 */
export const MULTI_PROTOCOL: { data: MockPool[] } = {
  data: [
    {
      pool: "aave-v3-base-usdc",
      chain: "Base",
