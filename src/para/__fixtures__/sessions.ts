...
/**
 * Session structure (matches storage/session.ts)
 */
 ...
 */
export const AUTHENTICATED_SESSION: TestSession = {
 ...
 */
export const UNAUTHENTICATED_SESSION: TestSession = {
 ...
 */
export const CUSTOM_ID_SESSION: TestSession = {
 ...
 */
export const ALTERNATE_USER_SESSION: TestSession = {
 ...
 */
export function createMockGetSession(session: TestSession | null) {
