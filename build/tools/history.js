...
import { getTransactionHistory, formatTransaction, } from "../para/client.js";
const SUPPORTED_CHAINS = ["ethereum", "base", "arbitrum", "optimism", "polygon"];
export function registerHistoryTool(server) {
...
- "Show my last 20 transactions"`,
        ...
        try {
            ...
            // Fetch history
            const history = await getTransactionHistory(chain, {
