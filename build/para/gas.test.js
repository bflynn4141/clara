...
import { getNativeBalance, getGasPrice, checkGasForTransaction, } from "./client.js";
    ...
    describe("GasPlan types", () => {
        ...
        it("should have gasSwap when pre-swap is needed", () => {
            ...
            const plan = {
                ...
                summary: "Insufficient ETH for gas. Will swap ~$3.50 of USDC to cover gas costs.",
            };
...
//# sourceMappingURL=gas.test.js.map